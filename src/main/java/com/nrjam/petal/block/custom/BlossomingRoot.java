...
public class BlossomingRoot extends BushBlock {
    private static final VoxelShape SHAPE = Block.column(12.0, 0.0, 14.0);

    public BlossomingRoot(Properties settings) {
        super(settings);
    }
    ...
    protected boolean mayPlaceOn(BlockState floor, @NonNull BlockGetter world, @NonNull BlockPos pos) {
        return floor.is(PetalBlocks.END_SOIL) || super.mayPlaceOn(floor, world, pos);
    }
}
